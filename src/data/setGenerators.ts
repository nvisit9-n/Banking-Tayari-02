...
import { getManagementQuestion } from './questionPools/topic7Management';
import { getBankingLawsQuestion } from './questionPools/topic8BankingLaws';
...
export function generateSingleSet(setId: number): RawSangathitSet {
  ...
  // Q31 to Q35: Section 7 - व्यवस्थापनका सिद्धान्त र कार्यहरू (Management Principles & Functions)
  questions.push(buildQuestion(31, setId, getManagementQuestion(31, setId)));
  questions.push(buildQuestion(32, setId, getManagementQuestion(32, setId)));
  questions.push(buildQuestion(33, setId, getManagementQuestion(33, setId)));
  questions.push(buildQuestion(34, setId, getManagementQuestion(34, setId)));
  questions.push(buildQuestion(35, setId, getManagementQuestion(35, setId)));

  // Q36 to Q40: Section 8 - बैंकिङ, लेखा र सम्बन्धित कानुनहरू (Banking, Accounting & Laws)
  questions.push(buildQuestion(36, setId, getBankingLawsQuestion(36, setId)));
  questions.push(buildQuestion(37, setId, getBankingLawsQuestion(37, setId)));
  questions.push(buildQuestion(38, setId, getBankingLawsQuestion(38, setId)));
  questions.push(buildQuestion(39, setId, getBankingLawsQuestion(39, setId)));
  questions.push(buildQuestion(40, setId, getBankingLawsQuestion(40, setId)));
