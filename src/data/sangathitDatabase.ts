...
export function convertRawSetToQuizSet(rawSet: RawSangathitSet): QuizSet {
  ...
  const questions: Question[] = rawSet.questions.map((q, idx) => {
    ...
    const options = (q.options || []).slice(0, 4).map((optText, optIdx) => {
      ...
      return {
        key,
        textNepali: cleanText,
        textEnglish: undefined
      };
    });
    ...
    if (qNum >= 1 && qNum <= 5) {
      category = 'GK';
      syllabusModule = 'खण्ड १: भूगोल, जनसङ्ख्या र वातावरण';
    } else if (qNum >= 6 && qNum <= 10) {
      category = 'GK';
      syllabusModule = 'खण्ड २: इतिहास, संस्कृति र सामाजिक व्यवस्था';
    } else if (qNum >= 11 && qNum <= 15) {
      category = 'Economics';
      syllabusModule = 'खण्ड ३: नेपालको आर्थिक विकास';
    } else if (qNum >= 16 && qNum <= 20) {
      category = 'Law';
      syllabusModule = 'खण्ड ४: संविधान र शासन व्यवस्था';
    } else if (qNum >= 21 && qNum <= 25) {
      category = 'GeneralAwareness';
      syllabusModule = 'खण्ड ५: अन्तर्राष्ट्रिय मामिला र संघ-संस्थाहरू';
    } else if (qNum >= 26 && qNum <= 30) {
      category = 'Computer';
      syllabusModule = 'खण्ड ६: विज्ञान, प्रविधि, जनस्वास्थ्य र समसामयिक';
    } else if (qNum >= 31 && qNum <= 35) {
      category = 'Management';
      syllabusModule = 'खण्ड ७: व्यवस्थापनका सिद्धान्त र कार्यहरू';
    } else if (qNum >= 36 && qNum <= 40) {
      category = 'Banking';
      syllabusModule = 'खण्ड ८: बैंकिङ, लेखा र सम्बन्धित कानुनहरू';
    } else if (qNum >= 41 && qNum <= 45) {
      category = 'Mathematics';
      syllabusModule = 'खण्ड ९: गणितीय क्षमता';
    } else if (qNum >= 46 && qNum <= 50) {
      category = 'GeneralAwareness';
      syllabusModule = 'खण्ड १०: सेवा सम्बन्धी लेखन तथा सञ्चार सीप र आचरण';
    }
