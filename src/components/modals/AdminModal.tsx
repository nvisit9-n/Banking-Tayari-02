                  ...
                  <table className="w-full text-left">
                    <thead className="bg-slate-50 dark:bg-slate-800 text-slate-500 font-bold border-b border-slate-200 dark:border-slate-800">
                      <tr>
                        <th className="p-3">विद्यार्थी</th>
                        <th className="p-3">जिल्ला / परीक्षा</th>
                        <th className="p-3">प्रगति / Level</th>
                        <th className="p-3">लाइसेन्स स्तर</th>
                        <th className="p-3">1-Click Toggle</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                      {filteredStudents.map(student => {
                        ...
                        return (
                          <tr key={student.id || student.email} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                            <td className="p-3">
                              <div className="flex items-center gap-2.5">
                                <img
                                ...
                                <div>
                                  ...
                                  <p className="text-slate-400 text-[10px]">{student.email || 'इमेल उपलब्ध छैन'}</p>
                                </div>
                              </div>
                            </td>
                            <td className="p-3">
                              <p className="font-medium text-slate-700 dark:text-slate-300">{student.district || 'काठमाडौँ'}</p>
                              <p className="text-slate-400 text-[10px]">{student.targetExam || 'NRB'}</p>
                            </td>
                            <td className="p-3">
                            ...
                            <td className="p-3">
                              <span className={`px-2.5 py-0.5 rounded-full font-bold text-[10px] ${
                                ...
                                {isStudentPro ? 'PRO ACTIVE 👑' : 'FREE STUDENT'}
                              </span>
                            </td>
                            <td className="p-3">
                              <button
